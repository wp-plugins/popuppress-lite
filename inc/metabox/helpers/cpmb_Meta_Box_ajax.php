...
class cpmb_Meta_Box_ajax {
	...
	public function oembed_handler() {
		...
		// verify our nonce
		if ( ! ( isset( $_REQUEST['cpmb_ajax_nonce'], $_REQUEST['oembed_url'] ) && wp_verify_nonce( $_REQUEST['cpmb_ajax_nonce'], 'ajax_nonce' ) ) )
			die();
		...
		if ( empty( $oembed_string ) )
			self::send_result( '<p class="ui-state-error-text">'. __( 'Please Try Again', 'cpmb' ) .'</p>', false );
